...
export const ProgramData: Program[] = [
  {
    ...
    description:
      'Sulit untuk menaikan berat badan, padahal sudah mencoba berbagai cara? tenang, Program Gain Weight in 21 Days dari Glance Fit dirancang khusus untuk membantumu mencapai berat badan ideal dengan metode yang sehat dan terbukti efektif.\n\nSelama tiga minggu, Kamu akan belajar lebih mendalam mengenai hal - hal yang dibutuhkan untuk menerapkan pola makan yang tepat demi menaikan berat badan.',
    isExclusive: false,
    isFollow: true,
    equipment: [
      {
  ...
  },
  {
    ...
    description:
      'Program diet sehat yg dirancang khusus utk membantumu mencapai berat badan ideal.',
    isExclusive: true,
    isFollow: false,
    equipment: [
      {
...
export const InstructionData: Instruction[] = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        steps: ['Pemanasan dasar', 'Latihan inti', 'Pendinginan'],
      },
    ],
  },
  {
