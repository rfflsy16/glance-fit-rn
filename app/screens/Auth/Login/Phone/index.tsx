...
import { View, Text, StyleSheet, TextInput, KeyboardAvoidingView, Platform, TouchableOpacity, Keyboard } from 'react-native';
...
export default function Phone() {
    ...
    function handleContinue() {
        if (phoneNumber.length > 0) {
            navigation.navigate('Verification', { phoneNumber: `+62${phoneNumber}` });
        }
    }
